            ...
            <StyledComponet>
                <form onSubmit={handleSubmit}>
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-3 col-form-label" > Customer Id</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="currentBalance" class="col-sm-3 col-form-label"> Deposit Amount  </label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="staticEmail" class="col-sm-3 col-form-label"> Loan Status  </label>
                        <div class="col-md-4">
